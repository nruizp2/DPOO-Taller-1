...
public class ConsolaOlimpicos
{
	...
	private void ejecutarPaisAtleta() {
		...
		String evento = input("Ingrese el nombre del atleta: ");
		String pais = calculadora.paisAtleta(evento);
		System.out.println("El atleta " + evento + " representa al país: " + pais);
	}
	...
	public void mostrarMenu()
	{
		...
		System.out.println("14. País que representa un atleta\n");
	}
